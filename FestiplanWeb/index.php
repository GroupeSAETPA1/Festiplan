...
<div class="app">
    <div class="partiePrincipale">
        <div class="formulaire creationCompte">
            <form method="post" action="FestiplanWeb?controller=UserController&action=inscription">
                <div class="form-duo">
        ...
        <div class="formulaire connexion">
            <form method="post" action="FestiplanWeb?controller=UserController&action=connexion">
                <div class="colonneCreationCompte">
